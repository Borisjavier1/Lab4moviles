...
class RecyclerView_Adapter8(private var items: ArrayList<AdministradorAPIItem>): RecyclerView.Adapter<RecyclerView.ViewHolder>(), Filterable {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        val personListView = LayoutInflater.from(parent.context).inflate(R.layout.templateadministradores, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.tvNombre)?.text = "Nombre del administrador "+item?.nombre
