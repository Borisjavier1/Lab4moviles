...
class CreatePersonFragment : FragmentUtils() {
    ...
    override fun onCreateView(
        ...
        if(sentPerson != null){
            ...
            view.findViewById<EditText>(R.id.editText_est).setText(persona.user)
            view.findViewById<EditText>(R.id.editText_Group).setText(persona.nombre)
            view.findViewById<EditText>(R.id.exitText_Nota).setText(persona.password)
    ...
    private fun createPerson(){
        ...
        var editTextName = view?.findViewById<EditText>(R.id.editText_Group)
        var editTextUser = view?.findViewById<EditText>(R.id.editText_est)
        var editTextPassword = view?.findViewById<EditText>(R.id.exitText_Nota)
